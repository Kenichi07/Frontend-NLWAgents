...
export function CreateRoomForm() {
  ...
  const createRooomForm = useForm<CreateRoomFormData>({
  ...
  return (
    <Card>
      ...
      <CardContent>
        <Form {...createRooomForm}>
          <form
            className="flex flex-col gap-4"
            onSubmit={createRooomForm.handleSubmit(handleCreateRoom)}
          >
            <FormField
              control={createRooomForm.control}
              name="name"
              render={({ field }) => {
                return (
                  <FormItem>
